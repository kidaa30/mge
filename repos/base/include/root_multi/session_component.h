 ...
 */
/*
 * update: changing the session inhertance defination to fix th proplem of using bulk transfer 
...
namespace Genode
{
	...
	template <typename SESSION_TYPE,typename INTERFACE,unsigned STACK_SIZE>
	class Session_component_multi : public Genode::Rpc_object<SESSION_TYPE,INTERFACE>
	{
		private:

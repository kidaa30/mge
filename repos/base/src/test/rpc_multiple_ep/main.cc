...
namespace Log
{
	 ...
	 */
	class Session_component : public Genode::Session_component_multi<Log_session,Session_component, STACK_SIZE>,
	                          public Genode::List<Session_component>::Element
	{
		public:
			Session_component(Genode::Cap_session *cap)
			: Genode::Session_component_multi<Log_session, Session_component,STACK_SIZE>(cap, "log_session_ep")
			{ }
